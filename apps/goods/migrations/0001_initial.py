    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('print', models.DecimalField(verbose_name='价格', decimal_places=2, max_digits=10)),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('url', models.CharField(verbose_name='活动链接', max_length=100)),
        ...
        migrations.AddField(
            model_name='goodssku',
            name='spu',
            field=models.ForeignKey(verbose_name='商品SPU', to='goods.GooodsSPU'),
        ),
        migrations.AddField(
